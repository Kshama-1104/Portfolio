...
const testimonials = [
  {
    testimonial: "Kshama is a passionate developer who brings clarity and innovation to every project.",
    name: "Peer Reviewer",
  ...
  {
    testimonial: "Kshama's work in ML and cloud automation is top-notch. Highly recommended!",
